/*--------------------------------------------------------------------------
  Tool name  	:multiping
  Module name   :multiping.c
  Detail        :ping to multiple IP adress
...
/*--------------------------------------------------------------------------
  Version history
   1. Create new                          R.I     Ver.1.0   2018/04/13
   2. Change variable to be readable      R.I     Ver.1.1   2018/04/19
 --------------------------------------------------------------------------*/
...
int main(int argc, char *argv[])
{
  ...
  printf("-----------------------------------------------\n");
  printf("A multiping targets %d IP address:\n", intMax);
  printf("-----------------------------------------------\n");
